...
//             setCategories(data);
//             console.log('&&&&&ContentCatalog->data', data);
//         } catch (error) {
//             console.log('ContentCatalog->error', error);
//         }
//     };
...
//                         {/* Можете додати підкатегорії або просто використовувати категорію */}
//                         <ul className={styles.subCategoryList}>
//                             <li className={styles.subCategoryItem} onClick={handleCloseClick}>
